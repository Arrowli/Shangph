            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active: isOne}" @click="changeOrder('1')">
                  <a>
                    综合
                    <i v-show="isOne" class="iconfont" :class="{'icon-Up-' : isAsc, 'icon-Down-' : isDesc}"></i>
                  </a>
                </li>
                <li :class="{active: isTwo}" @click="changeOrder('2')">
                  <a>
                    价格
                    <i v-show="isTwo" class="iconfont" :class="{'icon-Up-' : isAsc, 'icon-Down-' : isDesc}"></i>
                  </a>
                </li>
              </ul>
            </div>
...
export default {
  ...
  methods: {
    ...
    //收集平台属性地方回调函数（自定义事件） 然后再改变存的参数，再发请求
